...
[A_return, b_return,basic_variables,~,~,flag] = simplex_iteration(A_new,b,c_new,basic_variables);
if flag == 0
    X = 'NA';
    Z = 'NA';
else 
    ...
    b_refined = b_return;
    c_refined = c;
    [A, b,basic_variables,Z,~,flag] = simplex_iteration(A_refined,b_refined,c_refined,basic_variables);
    if flag == 0
        X = 'NA';
        Z = 'NA';
